...
/* safety subsystem wrap sw_rst_0 register */
...
/* safety subsystem wrap sw_rst_1 register */
...
/* safety subsystem wrap sw_rst_2 register */
...
/* safety subsystem wrap sw_rst_3 register */
...
/* safety subsystem wrap sw_rst_4 register */
...
/* safety subsystem top sw_rst_0 register */
#define SAFE_PINREG_SW_PRST                 0
#define SAFE_TOP_LPC_SW_RST                 1
#define SAFETY_PLL_CTRL_SW_PRST             2
...
/* ISP subsystem sw_rst_0 register */
#define LVDS0_SW_RST                        0
#define LVDS1_SW_RST                        1
#define ISP_BW_LMT_SW_RST                   2
#define ISP_LPC_SW_RST                      3
#define ISP_MM_SW_RST                       4
#define ISP_CORE_SW_RST                     5
#define ISP_CFG_SW_RST                      6
#define ISP_FBCDC_SW_RST                    7
#define ISP_CDMA_SW_RST                     8
#define ISP_HSK_SW_RST                      9
#define ISP_SIF_SW_RST                      10
#define ISP_SIF_LVDS_SW_RST                 11
#define ISP_SIF_RAW0_SW_RST                 12
#define ISP_SIF_RAW1_SW_RST                 13
#define ISP_SIF_YUV0_SW_RST                 14
#define ISP_SIF_YUV1_SW_RST                 15
#define ISP_IFE_WDMA_RAW_SW_RST             16
#define ISP_IFE_WDMA_YUV_SW_RST             17
#define ISP_RES_SW_RST                      18
#define ITP_CORE_SW_RST                     19
#define ITP_CFG_SW_RST                      20
#define ITP_PIPE_SW_RST                     21
#define ITP_3A_SW_RST                       22
#define ITP_RES_SW_RST                      23
#define ISP_ISO_24M_SW_RST                  24
#define ISP_ISO_SW_PRST                     25

/* ISP subsystem sen sw_rst_0 register */
#define SEN_I2C0_SW_PRST                    0
#define SEN_I2C1_SW_PRST                    1
#define SEN_I2C6_SW_PRST                    2
#define SEN_I2C0_SW_RST                     3
#define SEN_I2C1_SW_RST                     4
#define SEN_I2C6_SW_RST                     5
#define SEN_SPI_M0_SW_PRST                  6
#define SEN_SPI_M0_SW_RST                   7
#define SEN_LPWM_SW_PRST                    8
#define SEN_LPWM_SW_RST                     9
#define CSIRX0_SW_PRST                      10
#define CSIRX1_SW_PRST                      11
#define SEN_PINMUX_SW_PRST                  12
#define SEN_GPIO0_SW_PRST                   13
#define SEN_GPIO0_SW_RST                    14
#define SEN_AX_PWM0_SW_PRST                 15
#define SEN_AX_PWM01_SW_RST                 16
#define SEN_AX_PWM02_SW_RST                 17
#define SEN_AX_PWM03_SW_RST                 18
#define SEN_AX_PWM04_SW_RST                 19
#define SEN_AX_PWM05_SW_RST                 20
#define SEN_AX_PWM06_SW_RST                 21
#define SEN_AX_PWM07_SW_RST                 22
#define SEN_AX_PWM08_SW_RST                 23
#define SEN_TIMESTAMP1_SW_PRST              24
#define SEN_TIMESTAMP1_SW_RST               25
#define DPHY_RX0_SW_RST                     26
#define DPHY_RX1_SW_RST                     27
#define SYS_CSIRX0_SW_RST                   28
#define SYS_CSIRX1_SW_RST                   29
#define RX_BYTE0_SW_RST                     30
#define RX_BYTE1_SW_RST                     31

/* ISP subsystem sen sw_rst_1 register */
#define PIXEL_IF0_SW_RST                    0
#define PIXEL_IF1_SW_RST                    1

/* MM subsystem sw_rst_0 register */
#define CSITX_SW_PRST                       0
#define PHY_TXBYTEHS_SW_RST                 1
#define PPI_TX_ESC_SW_RST                   2
#define DPHY_TX_SW_RST                      3
#define MM_LPC_SW_RST                       4

/* MM subsystem mm_core sw_rst_0 register */
#define MM_CMD_SW_PRST                      0
#define MM_CMD_SW_RST                       1
#define MM_BW_LMT_24M_SW_RST                2
#define MM_VPP_SW_PRST                      3
#define MM_VPP_SW_RST                       4
#define MM_VPP_SCL0_SW_RST                  5
#define MM_VPP_SCL1_SW_RST                  6
#define MM_VPP_SCL2_SW_RST                  7
#define MM_VPP_SCL3_SW_RST                  8
#define MM_VPP_SCL4_SW_RST                  9
#define MM_AXI2CSI_SW_PRST                  10
#define MM_AXI2CSI_SW_RST                   11
#define MM_GDC_SW_PRST                      12
#define MM_GDC_SW_RST                       13
#define MM_DPU_SW_PRST                      14
#define MM_DPU_SW_RST                       15
#define MM_IVE_SW_PRST                      16
#define MM_IVE_SW_RST                       17
#define MM_FBCDC_SW_PRST                    18
#define MM_ISO_24M_SW_RST                   19
#define MM_ISO_SW_PRST                      20
#define MM_CVE_SW_PRST                      21
#define MM_CVE_SW_RST                       22
#define MM_EGM_SW_PRST                      23
#define MM_EGM_SW_RST                       24
#define MM_PRS_SW_PRST                      25
#define MM_PRS_SW_RST                       26
#define MM_TGL_SW_PRST                      27
#define MM_TGL_SW_RST                       28

/* NPU subsystem sw_rst_0 register */
#define NN_DAU_SW_RST                       0
#define NN_NEUSIGHT_SW_RST                  1
#define NN_TMR_SW_RST                       2
#define NN_PERF_MNR_SW_RST                  3
#define NN_TMR_SW_PRST                      4
#define NN_AXI_TMO_24M_SW_RST               5
#define NN_BW_LMT_24M_SW_RST                6
#define NN_PERF_MNR_24M_SW_RST              7
#define NN_LPC_SW_RST                       8

/* VPU subsystem sw_rst_0 register */
#define JENC_SYS_SW_RST                     0
#define VPU_FBDC_SW_RST                     1
#define VENC_BW_LMT_24M_SW_RST              2
#define JENC_BW_LMT_24M_SW_RST              3
#define VENC_BW_LMT_SW_ARST                 4
#define JENC_BW_LMT_SW_ARST                 5
#define VPU_LPC_SW_RST                      6
#define VPU_ADDR_REMAP2_SW_PRST             7
#define VPU_ADDR_REMAP3_SW_PRST             8
#define JENC_ADDR_REMAP_SW_PRST             9
#define VENC_AVC_SYS_SW_RST                 10
#define VENC_AXI_SW_RST                     11
#define VENC_AVC_GBL_SW_RST                 12
#define JENC_USW_SW_RST                     13
#define VPU_ISO_24M_SW_RST                  14
#define VPU_ISO_SW_PRST                     15
