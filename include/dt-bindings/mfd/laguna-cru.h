...
/* ISP clock & rst */
#define LAGUNA_ISP_CLK_MUX_0             CLK_MUX_OFFSET
#define LAGUNA_ISP_CLK_G_EB_0            CLK_GATE0_EB_OFFSET
#define LAGUNA_ISP_SW_RST_0              SW_RST0_OFFSET

/* ISP Sen clock & rst */
#define LAGUNA_ISP_SEN_CLK_MUX_0         CLK_MUX_OFFSET
#define LAGUNA_ISP_SEN_CLK_M_EB_0        CLK_MUX_EB_OFFSET
#define LAGUNA_ISP_SEN_CLK_G_EB_0        CLK_GATE0_EB_OFFSET
#define LAGUNA_ISP_SEN_CLK_G_EB_1        CLK_GATE1_EB_OFFSET
#define LAGUNA_ISP_SEN_CLK_M_DIV_0       0x80
#define LAGUNA_ISP_SEN_SW_RST_0          SW_RST0_OFFSET
#define LAGUNA_ISP_SEN_SW_RST_1          SW_RST1_OFFSET

/* MM clock & rst */
#define LAGUNA_MM_CLK_MUX_0              CLK_MUX_OFFSET
#define LAGUNA_MM_CLK_M_EB_0             CLK_MUX_EB_OFFSET
#define LAGUNA_MM_CLK_G_EB_0             CLK_GATE0_EB_OFFSET
#define LAGUNA_MM_SW_RST_0               SW_RST0_OFFSET

/* MM core clock & rst */
#define LAGUNA_MM_CORE_CLK_MUX_0         CLK_MUX_OFFSET
#define LAGUNA_MM_CORE_CLK_G_EB_0        CLK_GATE0_EB_OFFSET
#define LAGUNA_MM_CORE_SW_RST_0          SW_RST0_OFFSET

/* NPU clock & rst */
#define LAGUNA_NPU_CLK_MUX_0             CLK_MUX_OFFSET
#define LAGUNA_NPU_CLK_G_EB_0            CLK_GATE0_EB_OFFSET
#define LAGUNA_NPU_SW_RST_0              SW_RST0_OFFSET

/* VPU clock & rst */
#define LAGUNA_VPU_CLK_MUX_0             CLK_MUX_OFFSET
#define LAGUNA_VPU_CLK_G_EB_0            CLK_GATE0_EB_OFFSET
#define LAGUNA_VPU_SW_RST_0              SW_RST0_OFFSET
